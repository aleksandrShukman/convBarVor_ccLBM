...
class BoundaryVoxel : public Voxel
{
public:
	//!constructor
	BoundaryVoxel() : Voxel() { tag_ = "boundary"; }

	BoundaryVoxel(double x, double y, double z, int indexI, int indexJ, int indexK, int level) : Voxel(x, y, z, indexI, indexJ, indexK, level)
	{
		tag_ = "boundary";
	}

	//!destructor
	virtual ~BoundaryVoxel() {}
